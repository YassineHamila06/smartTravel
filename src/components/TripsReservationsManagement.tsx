...
} from "../../services/TRIP-RESERVATION-API";
...
const ReservationsManagement = () => {
  ...
  const { data: selectedReservationData, isLoading: isLoadingDetails } =
    useGetReservationQuery(selectedReservationId || "", {
  ...
  const reservations: Reservation[] = (reservationsData || []).map(
    (res: ApiReservation) => ({
      id: res._id,
      clientFirstName: res.userId?.name || "Unknown",
      clientLastName: res.userId?.lastname || "User",
      reservationDate: new Date(res.createdAt).toISOString().split("T")[0],
      tripName: res.tripId?.destination || "Unknown Trip",
      persons: res.numberOfPeople || 0,
      status: res.status,
    })
  );
  ...
  const filteredReservations = reservations.filter((reservation) => {
    ...
    const tripMatch = reservation.tripName.toLowerCase().includes(searchLower);
    ...
    return (nameMatch || tripMatch || idMatch) && statusMatch;
  });
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold text-gray-800 mb-4">
                      Reservation #{selectedReservationData._id}
                    </h3>
                    <div className="bg-gradient-to-r from-turquoise-50 to-white p-4 rounded-lg">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-900">
                            {selectedReservationData.numberOfPeople}
                          </p>
                        </div>
                        <div>
                          <p className="text-sm font-medium text-gray-500">
                    ...
                    <div className="bg-gradient-to-r from-turquoise-50 to-white p-4 rounded-lg">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                          ...
                          <p className="text-sm text-gray-900">
                            {selectedReservationData.userId?.name}{" "}
                            {selectedReservationData.userId?.lastname}
                          </p>
                        </div>
                        <div>
                          <p className="text-sm font-medium text-gray-500">
                          ...
                          <p className="text-sm text-gray-900">
                            {selectedReservationData.userId?._id}
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="bg-gradient-to-r from-turquoise-50 to-white p-4 rounded-lg">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                          ...
                          <p className="text-sm text-gray-900">
                            {selectedReservationData.tripId?.destination}
                          </p>
                        </div>
                        <div>
                          <p className="text-sm font-medium text-gray-500">
                          ...
                          <p className="text-sm text-gray-900">
                            {selectedReservationData.tripId?._id}
                          </p>
                        </div>
                      </div>
                    </div>
