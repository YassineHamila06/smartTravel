...
import { SurveyEditor } from "../survey";
import { useSurvey } from "../SurveyContextCore";
import { Survey } from "../../types";

const SurveyEditorPage: React.FC = () => {
  const { id } = useParams<{ id: string }>();
  const { getSurvey, addSurvey, updateSurvey, publishSurvey } = useSurvey();
  ...
  return (
    <div>
      ...
      <SurveyEditor initialSurvey={survey || undefined} onSave={handleSave} />
    </div>
  );
};
